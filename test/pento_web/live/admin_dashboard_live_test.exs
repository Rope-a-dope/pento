defmodule PentoWeb.AdminDashboardLiveTest do
  ...
  @create_user_attrs %{username: "test", email: "test@test.com", password: "passwordpassword"}
  @create_user2_attrs %{username: "test2", email: "test2@test.com", password: "passwordpassword"}
  @create_user3_attrs %{username: "test3", email: "test3@test.com", password: "passwordpassword"}
